...
3. **Render the HTML**
    Finally, run `jupyter nbconvert --to html ./examples/Jupyter/example.ipynb` to render the HTML document.
...
See the simple, minimal example in [`examples/HTML`](https://github.com/mattjmeier/gene-tooltips/tree/main/examples/HTML).